...
DROP SCHEMA IF EXISTS EJEMPLO2;
...
DROP PROCEDURE IF EXISTS PromedioArea;

DELIMITER //

CREATE PROCEDURE PromedioArea(IN Percentil INT) 
BEGIN
  SELECT name FROM country 
  WHERE SurfaceArea < (SELECT AVG(SurfaceArea) FROM country)/Percentil;
END //
...
CALL PromedioArea(10);

SHOW PROCEDURE STATUS;

SHOW CREATE PROCEDURE PromedioArea;